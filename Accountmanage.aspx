<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Accountmanage.aspx.cs" Inherits="Accountmanage" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <form   method="post" action="Accountmanage_Action.aspx">
                                    <tr>
                                        <td>##</td>
                                        <td><input name="txt_Name" type="text" style="width:70px"/></td>
                                        <td><input name="txt_Account" type="text" style="width:100px"/></td>
                                        <td><input name="txt_Password" type="text" style="width:100px"/></td>
                                        <td><input name="txt_Tel" type="text" style="width:100px" /></td>
                                        <td><select name="Sele_Gender" >
                                                <option value="1" selected="selected">男</option>
                                                <option value="2" >女</option>
                                            </select></td>
                                        <td><input name="txt_Address" type="text" style="width:200px"/></td>
                                        <td>
                            ...
                            <%
                                ...
                                conn.Open();
                                sqlcommand = new System.Data.SqlClient.SqlCommand("select * from [Member]", conn); //查詢所有會員資訊
                                ...
                                <form  method="post" action="Accountmanage_Action.aspx">
                                    <tr>
                                       <!-- 將讀取所有會員資料 套入到表格中  -->
                                        ...
                                        <td><input name="txt_Name" type="text" style="width:70px" value="<%Response.Write(dr["M_Name"].ToString()); %>" /></td>
                                        <td><input name="txt_Account" type="text" style="width:100px" value="<%Response.Write(dr["M_Account"].ToString()); %>" /></td>
                                        <td><input name="txt_Password" type="password" style="width:100px" value="<%Response.Write(dr["M_Password"].ToString()); %>" /></td>
                                        <td><input name="txt_Tel" type="text" style="width:100px" value="<%Response.Write(dr["M_Tel"].ToString()); %>" /></td>
                                        <td><select name="Sele_Gender" >
                                                <option value="1" <%if (dr["M_Gender"].ToString() == "男") { %>selected="selected"<%}%>>男</option>
                                                <option value="2" <%if (dr["M_Gender"].ToString() == "女") { %>selected="selected"<%}%>>女</option>
                                            </select></td>
                                        <td><input name="txt_Address" type="text" style="width:200px" value="<%Response.Write(dr["M_Address"].ToString()); %>" /></td>
                                        <td>
                                                                                   <!-- 進行 編輯/刪除 導向Accountmanage_Action.aspx.cs進行程式執行  -->
                                            <input name="Hid_Num" style="display:none" value="<%Response.Write(dr["M_num"].ToString()); %>" />
