        ...
        <div class="container">
            <div class="row">
                <div class="col-2" style="border:solid">
                    <h4><a href="ProductDisplay.aspx">分類</a></h4>
                    <ul style="text-align:center;">
                        <%
                            ...
                            {
                        %>
                        <li><a href="ProductDisplay.aspx?Classify=<%Response.Write(dr["PC_num"].ToString()); %>"><%Response.Write(dr["PC_Name"].ToString()); %></a></li>
                        <%
                            }
                            dr.Close();
                            conn.Close();
                ...
                <div class="col-10">
                    <%
                        ...
                        if (Request.QueryString["Classify"] == null)
                            sqlcommand = new System.Data.SqlClient.SqlCommand("select P_num,P_Name,P_Price,P_Description,P_Image from Product", conn); //查詢所有會員資訊
                        else
                            sqlcommand = new System.Data.SqlClient.SqlCommand("select P_num,P_Name,P_Price,P_Description,P_Image from Product WHERE PClassify_num=" + Request.QueryString["Classify"], conn); //查詢所有會員資訊
                        dr = sqlcommand.ExecuteReader();
                        while (dr.Read())
                        {
                    %>
                    <div class="media" style="background-color:rgba(128, 128, 128,0.8); width:90%; margin:0 auto; border-radius:10px; padding:10px">
