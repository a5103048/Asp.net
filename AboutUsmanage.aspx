<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AboutUsmanage.aspx.cs" Inherits="AboutUsmanage" %>
                        ...
                        <div class="container">
                            <div class="Inform">
                                <form id="form1" runat="server">
                                    <p>標題: <br />
                                        <asp:TextBox ID="txt_Tital" runat="server" Font-Size="10"></asp:TextBox>
                                    </p>
                                    <br />
                                    <p>內容: <br />
                                        <asp:TextBox ID="txt_Contents" runat="server" Font-Size="10" TextMode="MultiLine" Rows="20" Width="600px"></asp:TextBox>
                                    </p>
