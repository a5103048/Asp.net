<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SecondHandProductmanage.aspx.cs" Inherits="SecondHandProductmanage" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <form method="post" action="SecondHandProductmanage_Action.aspx" enctype="multipart/form-data">
                                    <tr>
                                        <td>##</td>
                                        <td><input name="txt_Name" type="text" style="width:70px"/></td>
                                        <td><input name="txt_Price" type="text" style="width:70px"/></td>
                                        <td><textarea name="txt_Info" rows="5" ></textarea></td>
                                        <td><input name="File_Img" type="file" style="width:200px" accept="image/jpeg" /></td>
                                        <td><input name="txt_SellerName" type="text" style="width:100px" /></td>
                                        <td><input name="txt_SellerPhone" type="text" style="width:100px" /></td>
                                        <td>
                                ...
                                <form  method="post" action="SecondHandProductmanage_Action.aspx" enctype="multipart/form-data">
                                    <tr>
                                       <!-- 將讀取所有會員資料 套入到表格中  -->
                                        ...
                                        <td><%Response.Write(dr["SHP_num"].ToString()); %></td>
                                        <td><input name="txt_Name" type="text" style="width:70px" value="<%Response.Write(dr["SHP_Name"].ToString()); %>" /></td>
                                        <td><input name="txt_Price" type="text" style="width:70px" value="<%Response.Write(dr["SHP_Price"].ToString()); %>" /></td>
                                        <td><textarea name="txt_Info" rows="5"><%Response.Write(dr["SHP_Info"].ToString()); %></textarea></td>
                                        <td>
                                            <img style="width:100px; height:100px" src="<%Response.Write(dr["SHP_Img"].ToString()); %>" />
                                            <br />
                                            <input name="File_Img" type="file" style="width:200px" accept="image/jpeg" />
                                        </td>
                                        <td><input name="txt_SellerName" type="text" style="width:100px" value="<%Response.Write(dr["SHP_SellerName"].ToString()); %>" /></td>
                                        <td><input name="txt_SellerPhone" type="text" style="width:100px" value="<%Response.Write(dr["SHP_SellerPhone"].ToString()); %>" /></td>

                                        <td>
                                                                                   <!-- 進行 編輯/刪除 導向Accountmanage_Action.aspx.cs進行程式執行  -->
                                            <input name="Hid_Num" style="display:none" value="<%Response.Write(dr["SHP_num"].ToString()); %>" />
