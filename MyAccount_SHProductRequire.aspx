<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyAccount_SHProductRequire.aspx.cs" Inherits="MyAccount_SHProductRequire" %>
            ...
            <div class="col-9">
                <form id="form1" runat="server"> 
                    <div class="form-group">
                        <label>名稱: </label>
                        <asp:TextBox CssClass="form-control" ID="txt_Name" runat="server" placeholder="名稱"></asp:TextBox>
                    </div>
                    <br />

                    <div class="form-group">
                        <label>價格: </label>
                        <asp:TextBox CssClass="form-control" ID="txt_Price" runat="server" placeholder="價格"></asp:TextBox>
                    </div>
                    <br />

                    <div class="form-group">
                        <label>介紹: </label>
                        <asp:TextBox CssClass="form-control" ID="txt_Info" runat="server"  placeholder="介紹" TextMode="MultiLine" Rows="5"></asp:TextBox>
                    </div>
                    <br />
                    ...
                    <center><asp:Button ID="btn_Require" runat="server" Text="申請上架" CssClass="btn btn-primary btn-block" OnClick="btn_AccEdit_Click" Width="150px"/></center>
                </form>
            </div>
          </div>
        </div>
