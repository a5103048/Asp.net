<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adminmanage.aspx.cs" Inherits="Admin" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <form method="post" action="Adminmanage_Action.aspx">
                                    <tr>
                                        <td>##</td>
                                        <td><input name="txt_Acc" type="text" style="width:70px"/></td>
                                        <td><input name="txt_Pw" type="password" style="width:70px"/></td>
                                        <td>
                            ...
                            <%
                                ...
                                conn.Open();
                                sqlcommand = new System.Data.SqlClient.SqlCommand("select * from [AdminAccount]", conn); //查詢所有會員資訊
                                ...
                                try
                                {
                                    ...
                                    {
                            %>
                                <form  method="post" action="Adminmanage_Action.aspx" enctype="multipart/form-data">
                                    <tr>
                                       <!-- 將讀取所有會員資料 套入到表格中  -->

                                        <td><%Response.Write(dr["Ad_Id"].ToString()); %></td>
                                        <td><input name="txt_Acc" type="text" style="width:70px" value="<%Response.Write(dr["Ad_Acc"].ToString()); %>" /></td>
                                        <td><input name="txt_Pw" type="password" style="width:70px" value="<%Response.Write(dr["Ad_Pw"].ToString()); %>" /></td>

                                        <td>
                                                                                   <!-- 進行 編輯/刪除 導向Accountmanage_Action.aspx.cs進行程式執行  -->
                                            <input name="Hid_Num" style="display:none" value="<%Response.Write(dr["Ad_Id"].ToString()); %>" />
