<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClassifymanage.aspx.cs" Inherits="ProductClassifymanage" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <form  runat="server" method="post" action="ProductClassifymanage_Action.aspx" enctype="multipart/form-data">
                                    <tr>
                                        <td>##</td>
                            ...
                            <%
                                ...
                                try
                                {
                                    ...
                                    {
                            %>
                                <form  method="post" action="ProductClassifymanage_Action.aspx" enctype="multipart/form-data">
                                    <tr>
                                       <!-- 將讀取所有會員資料 套入到表格中  -->

                                        <td><%Response.Write(dr["PC_num"].ToString()); %></td>
                                        <td><input name="txt_Name" type="text" style="width:70px" value="<%Response.Write(dr["PC_Name"].ToString()); %>" /></td>
                                        <td>
                                                                                   <!-- 進行 編輯/刪除 導向Accountmanage_Action.aspx.cs進行程式執行  -->
                                            <input name="Hid_Num" style="display:none" value="<%Response.Write(dr["PC_num"].ToString()); %>" />
